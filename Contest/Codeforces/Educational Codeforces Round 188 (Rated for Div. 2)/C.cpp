...
void solve()
{
    ...
    int64_t k3=lcm(c,a);
    int64_t k4=lcm(k1,c);
    int64_t ansa=(m/a)-(m/(k1))-(m/(k3))+(m/(k4));
    int64_t ansb=m/b-m/(k1)-m/(k2)+(m/(k4));
    int64_t ansc=m/c-m/(k2)-m/(k3)+(m/(k4));
    ansa=6*ansa;
    ansa+=3*((m/(k1))+m/(k3)-2*(m/k4));
    ansa+=2*(m/k4);
    ansb=6*ansb;
    ansb+=3*((m/(k1))+m/(k2)-2*(m/k4));
    ansb+=2*(m/k4);
    ansc=6*ansc;
    ansc+=3*((m/(k2))+m/(k3)-2*(m/k4));
    ansc+=2*(m/k4);
