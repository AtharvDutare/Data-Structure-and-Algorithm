...
/* 
    ...
    we need ai<=bi for all i

    if we reverse the b array then append to a array 
    then it is a single non -decreasing array for possible values [0,N]

    with total 2m
    here 2m we talk about total frequency of elements 
