...
void printAll(Args... args) {
    // This trick prints each argument followed by a space
...
For every index i in a , decrease ai by i
.
For every index i in a, decrease ai by n−i+1
.
