...
/* clang-format on
    ...
    INITUTION 
    if atleast one odd and one even the k=2;
    if distinct element is 2 thne k=1


    PROBLEM when all are even or all are odd
...
void trail_Chamber() {
    vi a={11234322,423526234,323253422,403324232};
    int g=a[0];
