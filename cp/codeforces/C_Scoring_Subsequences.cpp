...
/* clang-format on 
 ...
 let you have a sequence of [a1,a2,a3,..,an] 
 and 
 score of it (a1*a2*a3...*an)/(!n)
 
 we have m is the maximum possible score of all the sub-sequence within the range 

 and cost is the no of such such sub-sequence of that score 
 

    INTUITION
    take ratio of ai/i 
    if it is >=1 then score increase the this new sub-sequence is ans 
        ans 
